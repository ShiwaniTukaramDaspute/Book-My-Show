...
<div className="absolute left-4 px-10 z-30 w-30 h-70  top-52 text-black font-bold rounded-2xl border-2 border-red-500" style={{ backgroundColor: "#F5E8C7"}}>
   ...
   <section className="flex items-center justify-between w-full px-4 py-1"
      ...
      <div className="pl-20">
        <button style={{width: "70px", backgroundColor: "rgb(255, 255, 255)", borderRadius: "8px", color: "rgb(51, 51, 51)", padding: "8px 12px", fontWeight: "bold", fontSize: "10px"}}>Rate now</button>
      </div>
   </section>
   ...
   <div className="flex flex-wrap gap-3" style={{color: "rgb(255, 255, 255)", fontSize: "12px", fontWeight: "normal"}}>
      ...
      <div className="mb-2" style={{fontSize: "10px", fontWeight: "normal", color: "black"}}>
